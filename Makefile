...
distdir: FORCE
	...
	$(COPY_FILE) --parents CheckConnection.h compare.h ConsoleTab.h ContributorTab2.h GeneralTab.h device.h Feedback.h GetHistory.h GetLocalDevices.h GetOS.h GetRemoteConfig.h HTTPDownloader.hpp Linuxconf.h NotebookGUI.h QuestionBox.h RestoreGUI.h RestoreTab.h RunConfig.h $(DISTDIR)/
	$(COPY_FILE) --parents CheckConnection.cpp ConsoleTab.cpp ContributorTab2.cpp GeneralTab.cpp device.cpp Feedback.cpp GetHistory.cpp GetLocalDevices.cpp GetOS.cpp GetRemoteConfig.cpp HTTPDownloader.cpp Linuxconf.cpp NotebookGUI.cpp QuestionBox.cpp RestoreGUI.cpp RestoreTab.cpp RunConfig.cpp $(DISTDIR)/
...
GeneralTab.o: GeneralTab.cpp GeneralTab.h \
		...
		ContributorTab2.h \
		HTTPDownloader.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GeneralTab.o GeneralTab.cpp
