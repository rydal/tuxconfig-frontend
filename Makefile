...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/include/boost -L/usr/include/qtermwidget5 -lqtermwidget5 -L/usr/local/include/curlpp -lcurlpp -L/usr/include/x86_64-linux-gnu/curl/ -lcurl -L/usr/include/jsoncpp -ljsoncpp -L/usr/lib/x86_64-linux-gnu -lboost_system /usr/lib/x86_64-linux-gnu/libQt5Widgets.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Core.so /usr/lib/x86_64-linux-gnu/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
