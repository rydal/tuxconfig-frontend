...
void RestoreTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RestoreTab *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RestoreTab::*)(Device , string , vector<string> );
...
QT_INIT_METAOBJECT const QMetaObject RestoreTab::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_RestoreTab.data,
    qt_meta_data_RestoreTab,
    qt_static_metacall,
    nullptr,
    nullptr
} };
