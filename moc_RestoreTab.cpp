...
QT_MOC_LITERAL(6, 53, 6) // "setTab"

    },
    "RestoreTab\0sendCommand\0\0Device\0string\0"
    "vector<string>\0setTab"
};
...
void RestoreTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setTab((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RestoreTab::sendCommand)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RestoreTab::setTab)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject RestoreTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RestoreTab.data,
      qt_meta_data_RestoreTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RestoreTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RestoreTab.stringdata0))
        return static_cast<void*>(const_cast< RestoreTab*>(this));
