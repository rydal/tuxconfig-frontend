...
void NotebookGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NotebookGUI *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (NotebookGUI::*)(Device );
        ...
        {
            using _t = void (NotebookGUI::*)(vector<string> , bool );
        ...
        {
            using _t = void (NotebookGUI::*)(Device , string , vector<string> );
        ...
        {
            using _t = void (NotebookGUI::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NotebookGUI::updates_available_signal)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject NotebookGUI::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_NotebookGUI.data,
    qt_meta_data_NotebookGUI,
    qt_static_metacall,
    nullptr,
    nullptr
} };
